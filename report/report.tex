\documentclass[a4paper,UKenglish,11pt]{article}
...
\title{\bfseries{Multi-class classification using multi-layer neural network}}
\author{
    \begin{tabular}{ll}
      Chen Chen & Mingxuan Li \tabularnewline 480458339 & 470325230
    \end{tabular}
}
\date{\today}
%\makeatother
